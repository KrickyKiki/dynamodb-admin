...
exports.createServer = (dynamodb, docClient) => {
  ...
  app.use('/dynamodb/assets', express.static(path.join(__dirname, '..', 'public')))
...
exports.dynamodbAdmin = (app, dynamodb, docClient) => {
  ...
  // ** Middleware
  return function dynamodbAdmin(req, res, next) {
    next();
  };
}
